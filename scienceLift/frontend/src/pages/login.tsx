/**
 * login.tsx - Login page with FitHub branding
 */
    ...
    <div className="min-h-screen bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:via-blue-900 dark:to-purple-900 flex relative overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative z-10">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 dark:from-blue-300 to-purple-600 dark:to-purple-300 mb-2">Welcome Back</h1>
          <p className="text-gray-700 dark:text-slate-400 mb-8 font-medium">Login to your ScienceLift account</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-bold text-gray-900 dark:text-slate-200 mb-2.5 uppercase tracking-wider">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-sm font-bold text-gray-900 dark:text-slate-200 mb-2.5 uppercase tracking-wider">Password</label>
              <input
                type="password"
                value={password}
          ...
          <p className="text-center text-gray-700 dark:text-slate-400 mt-8 font-medium">
            ...
            <Link href="/register" className="text-blue-600 dark:text-purple-400 font-bold hover:text-blue-700 dark:hover:text-purple-300 transition">
              Sign up
            </Link>
          </p>
        </div>
